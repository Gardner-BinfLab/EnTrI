...
\hline
\textbf{Biological process} & \textbf{Subprocess} & \textbf{Core essential} & \textbf{Accessory essential} & \textbf{Non-essential}\\
\hline
...
& Ribosome components & \begin{tabular}[t]{@{}l@{}}rplBCDEFJKLMNOPQRSTUV,\\ rplWXY, rpmABCD,\\ rpsABCDEFGHJKLMNPQRSTU\end{tabular} & rplA, rpmEGHI, rpsIO & rplI, rpmF\\
