...
toplot <- toplot[,seq(2,5)]
toplot <- toplot[ order(toplot$Citrobacter, toplot$Salmonella, toplot$Escherichia, toplot$Klebsiella,
                        row.names(toplot), decreasing = c(TRUE, TRUE, TRUE, TRUE, FALSE), method = 'radix'), ]
