...
for (filename in list_of_files)
{
  ...
  reg1 <- lm(ii~gc)
  plot(gc, ii, pch = '.', xlab = "GC content", ylab = "ii",
  ...
  if (filename == "../results/biases/check-biases//t.txt")
  {
    print(ii_dgcnormalised[which(biasestable$name == 't4064')])
  }
  ...
  biasestable$ii = ii_dgcnormalised
  if (filename == "../results/biases/check-biases//t.txt")
  {
    print(biasestable$ii[which(biasestable$name == 't4064')])
  }
  cutoff = 3
