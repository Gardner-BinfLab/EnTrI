...
{
  fisherresult = fisher.test(matrix(c(codon_table[i,2],codon_table[i,3],codon_table[nrow(codon_table),2],codon_table[nrow(codon_table),3]),nrow=2,byrow=TRUE), alternative = "less")
