...
outdir = '/home/fatemeh/EnTrI/results/define-core-accessory-hieranoid-fasta-2'
makedir(outdir)
...
species_names = {"all":["BN373", "ERS227112", "NCTC13441", "ROD", "SEN", "SL1344", "STM",
    ...
    "ecoli":["NCTC13441", "b","BW25113", "EC958"], "klebsiella":["ERS227112", "BN373"], "citrobacter":["ROD"],
...
with open('/home/fatemeh/EnTrI/results/define-core-accessory-hieranoid-fasta-2/info.txt', 'w') as infofile:
...
for item in species_names.keys():
    ...
    with open('/home/fatemeh/EnTrI/results/define-core-accessory-hieranoid-fasta-2/info.txt', 'a') as infofile:
