...
address = {'deg': '../results/deg/define-core-accessory-hieranoid/all/core-essential-genomes/hhmake/',
           'endo': '../results/endosymbionts/define-core-accessory-hieranoid/core-essential-genomes/hhmake/',
           'entcore': '../results/giant-tab/clusters/hhmake/'}
outdir = '../results/giant-tab/'

list_of_degs = listdir(address['deg'])
list_of_endos = listdir(address['endo'])
list_of_entcores = listdir(address['entcore'])

dict_of_lists = {'deg':list_of_degs, 'endo':list_of_endos, 'entcore':list_of_entcores}
