...
# out_path = 'test.txt'
species_names = ["BN373", "CS17", "ENC", "ERS227112", "ETEC", "NCTC13441", "ROD", "SEN", "SL1344", "SL3261", "STM", "STMMW", "t"]
num_species = len(species_names)
gene_dict = {species_names[i]: 0 for i in range(num_species)}
ii_dict = {species_names[i]: i for i in range(num_species)}
# name_dict = {"BN373": "KlebsiellapneumoniaeEcl8", "CS17": "EscherichiacoliETECCS17",
#              "ENC": "EnterobactercloacaeNCTC9394", "ERS227112": "KlebsiellapneumoniaeRH201207",
#              "ETEC": "EscherichiacoliETECH10407", "NCTC13441": "EscherichiacoliUPECST131",
#              "ROD": "CitrobacterrodentiumICC168", "SEN": "SalmonellaEnteritidisP125109",
#              "SL1344": "SalmonellaTyphimuriumSL1344", "SL3261": "SalmonellaTyphimuriumSL3261",
#              "STM": "SalmonellaTyphimuriumA130", "STMMW": "SalmonellaTyphimuriumD23580",
#              "t": "SalmonellaTyphiTy2"}
name_dict = {"BN373": "moniaeEcl8", "CS17": "liETECCS17",
             "ENC": "aeNCTC9394", "ERS227112": "aeRH201207",
             "ETEC": "ETECH10407", "NCTC13441": "iUPECST131",
             "ROD": "tiumICC168", "SEN": "disP125109",
             "SL1344": "riumSL1344", "SL3261": "riumSL3261",
             "STM": "muriumA130", "STMMW": "riumD23580",
             "t": "laTyphiTy2"}
