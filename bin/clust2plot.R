...
for (cpitem in clusters_path)
{
  ...
  screen(1)
  plot(h, col=c("darkgoldenrod4", "black", "dodgerblue2", "black", "red")[cuts], xlab = "Insertion index", main ="All gene classes", cex.lab = 2,
  ...
  plot(h, col=c("darkgoldenrod4", "black", "dodgerblue2", "black", "red")[cuts], xlab=NA, ylab=NA, main ="Genus specific", cex.axis=1.5, cex.main = 1.5,
  ...
  plot(h, col=c("darkgoldenrod4", "black", "dodgerblue2", "black", "red")[cuts], xlab=NA, ylab=NA, main ="Single copy", cex.axis=1.5, cex.main = 1.5,
       xlim=c(0,4), ylim=c(0,150), lty= "blank", axes=FALSE)
  axis(1, at=seq(0,4,1), cex.axis=1.5)
  ...
  #par(mar=c(2,1,2,1))
  par(mar=c(5.1,1,4.1,1))
  plot(h, col=c("darkgoldenrod4", "black", "dodgerblue2", "black", "red")[cuts], xlab = NA, ylab=NA, main ="Multi-copy", cex.axis = 1.5, cex.main = 1.5,
       xlim=c(0,4), ylim=c(0,150), lty= "blank", axes=FALSE)
  axis(1, at=seq(0,4,1), cex.axis=1.5)
  axis(2, at=seq(0,150,50), labels=c(NA,NA,NA,NA), cex.axis=1.5)
