...
midpoints <- barplot(toplot, main="All", xaxt="n", xlab="position", ylab="mean ii", cex.lab = 2, cex.axis = 2, cex.main =2, col=cols, border=NA)
axis(1, at=midpoints[c(1,100)], labels=c('5\'','3\''), cex.axis=1.5)
legend(41,0.7, c("First 5%","internal", "Last 20%"), lty=c(1,1,1),cex=2, lwd=c(4,4, 4),col=c(cols[1],cols[6],cols[81]), bg="white")
essential = c()
nonessential = c()
beneficialloss = c()
...
midpoints <- barplot(toplot, main="Essential", xaxt="n", xlab="position", ylab="mean ii", cex.lab = 2, cex.axis = 2, cex.main =2, col=cols, border=NA)
axis(1, at=midpoints[c(1,100)], labels=c('5\'','3\''), cex.axis=1.5)
legend(41,0.3, c("First 5%","internal", "Last 20%"), lty=c(1,1,1),cex=2, lwd=c(4,4, 4),col=c(cols[1],cols[6],cols[81]), bg="white")
toplot <- colMeans(nonessential)
midpoints <- barplot(toplot, main="Non essential", xaxt="n", xlab="position", ylab="mean ii", cex.lab = 2, cex.axis = 2, cex.main =2, col=cols, border=NA)
axis(1, at=midpoints[c(1,100)], labels=c('5\'','3\''), cex.axis=1.5)
legend(41,0.6, c("First 5%","internal", "Last 20%"), lty=c(1,1,1),cex=2, lwd=c(4,4, 4),col=c(cols[1],cols[6],cols[81]), bg="white")
toplot <- colMeans(beneficialloss)
midpoints <- barplot(toplot, main="Beneficial loss", xaxt="n", xlab="position", ylab="mean ii", cex.lab = 2, cex.axis = 2, cex.main =2, col=cols, border=NA)
axis(1, at=midpoints[c(1,100)], labels=c('5\'','3\''), cex.axis=1.5)
legend(41,1.5, c("First 5%","internal", "Last 20%"), lty=c(1,1,1),cex=2, lwd=c(4,4, 4),col=c(cols[1],cols[6],cols[81]), bg="white")
dev.off()
